    ...
    if val_model is None:
        try:
            ...
            if os.path.exists(PKL_PATH):
                ...
                val_rmse = pkl_data.get("rmse", 25000) # Fallback RMSE
            ...
            # 3. Chronos laden (Steady Version: Altijd van HuggingFace)
            ...
            print("✅ Alle resources succesvol geladen via HuggingFace!")
...
def generate_price_trend(property_input):
    """Genereert historische data en een 3-jarige prognose."""
    load_resources()
    ...
    # Median berekening over de samples
